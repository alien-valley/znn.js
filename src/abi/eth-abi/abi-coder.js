...
var token_standard_1 = require("./coders/token-standard");
var hash_1 = require("./coders/hash");
...
var AbiCoder = /** @class */ (function () {
    ...
    AbiCoder.prototype._getCoder = function (param) {
        ...
        switch (param.baseType) {
            ...
            case 'tokenStandard':
                return new token_standard_1.TokenStandardCoder(param.name);
            case 'hash':
                return new hash_1.HashCoder(param.name);
            case '':
